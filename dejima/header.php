...
<!-- <script src="https://www.googleoptimize.com/optimize.js?id=OPT-K8DWCSK"></script> -->
      ...
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/topics.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/topics.css'); ?>">
      ...
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/top.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/top.css'); ?>">
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/editor.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/editor.css'); ?>">
      <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
      <script src="<?php echo get_template_directory_uri();?>/js/remodal.min.js"></script>
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/comco_style.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/comco_style.css'); ?>">
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/simulation.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/simulation.css'); ?>">
      <script src="<?php echo get_template_directory_uri();?>/js/simulation.js"></script>
<!--      <link rel="stylesheet" href="<?php echo get_template_directory_uri();?>/style.css?Ver=2.1"> -->
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/support.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/support.css'); ?>">
      <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri().'/css/top.css'; echo '?' . filemtime( get_stylesheet_directory().'/css/top.css'); ?>">
...
document.getElementsByTagName('head')[0].appendChild(_bownow_ts);
      ...
      <SCRIPT language="JavaScript">
          function popup_confirm01(){
              window.open("https://business.form-mailer.jp/fms/8e5bae40179867","_new");
          }
      </SCRIPT>
  ...
  <body>
    ...
    <div id="header">
            <div class="header-pc-sub d-none d-lg-block">
              <p class="header-pc-sub-text">介護業界のICTをサポートするソリューションをお届けする情報サイト「COMRES コムレス」</p>
              <div class="header-pc-sub-link">
                <a href="<?php echo home_url();?>/concept/">コムレスとは？</a>
                <a href="<?php echo home_url();?>/company/">企業情報</a>
              </div>
            </div>
        <header>
            <a href="<?php echo home_url();?>/" class="logo-wrapper d-flex flex-row flex-wrap align-items-center"><h2 class="logo"><img src=<?php echo do_shortcode('[img]')."logo-comres.svg"?> ></h2><p class="logo-ja">- コムレス -</p></a>
...
//             echo $post_type;
            ...
            <div class="menu_wrap">
                <nav class="main_menu">
                    <ul>
                        <li><a <?php if(is_front_page() or is_home()) {?> class="active" <?php } ?> href="<?php echo home_url();?>/">TOP</a></li>
                        ...
                        <li><a <?php if(!is_search() && $post_type==='product') {?> class="active" <?php } ?> href="<?php echo home_url();?>/product/">製品情報</a></li>
                        ...
                        <li><a <?php if(!is_search() && $_SERVER['REQUEST_URI']==='/support/') {?> class="active" <?php } ?> href="<?php echo home_url();?>/support/">COMRESのトータルサポート</a></li>
                        <li class="btn-header-cv-contact d-none d-lg-block"><a href="https://business.form-mailer.jp/fms/9b83c954179866" target="_new"><i class="mail fa-solid fa-envelope faa-wrench animated mr-1"></i>お問い合わせ</a></li>
                        <li class="d-block d-lg-none"><a href="<?php echo home_url();?>/company/">企業情報</a></li>
                        <li class="d-block d-lg-none"><a href="https://business.form-mailer.jp/fms/9b83c954179866" target="_new">お問い合わせ</a></li>
                    </ul>
                </nav>
            </div>
        </header>
