  ...
  <?php if(have_posts()): while(have_posts()):the_post(); ?>
    ...
    <div class="page-title-container">
      <div class="bread-wrapper">
        <p class="bread"><a href="<?php echo home_url();?>">TOP</a> > <a href="<?php echo home_url();?>/topics/">トピックス</a> ><?php echo post_custom('トピックスタイトル'); ?></p>
      </div>
      <div class="page-title-wrapper">
        <div class="page-title-inner">
          <h1 class="text-md-center"><?php echo post_custom('トピックスタイトル'); ?></h1>
        </div>
      </div>
    </div>
