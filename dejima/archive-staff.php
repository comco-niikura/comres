      ...
      <div class="page-container">
        <section class="concept-wrapper">
          ...
          <?php if(have_posts()): while(have_posts()):the_post();?>
            <div class="staff-info-container d-flex flex-column flex-lg-row justify-content-around" id = "<?php echo get_the_author_meta('initial'); ?>">
                ...
                <div class="staff-otherinfo-wrapper">
                  ...
                  <dl>
                    <dt>コラム一覧</dt>
                      <dd>
                    <?php
                      $author_name = mb_strtolower(str_replace('．','', get_field("スタッフ名")));
                      $args = array(
                          'post_type' => 'column',
                          'order' => 'DESC',
                          'oderby' => 'post_date'
                      ...
                      <?php if($the_query->have_posts() ):
                          ...
                          <?php if($author_name == get_the_author_meta('initial')):?>
                        <li><a href="<?php the_permalink(); ?>" > <?php the_field('コラムタイトル'); ?> </a></li>
                      <?php endif; ?>
                    <?php endwhile; ?>
                    </ul>
                    <?php endif; ?>
          ...
          <div class="staff-fist-tt-wrapper">
            ...
            <img src=<?php echo do_shortcode('[img]')."staffpage-all.jpg"; ?> onerror = "this.src = '<?php echo do_shortcode('[img]')."members04.jpg"; ?>'" alt="">
          </div>
        </section>
      </div>
    </div>
